...
urlpatterns = [
    ...
    path("seller/brands/resolve/", views.SellerBrandResolveAPIView.as_view(), name="seller_brand_resolve"),
    ...
    path("seller/products/<int:pk>/images/", views.SellerProductImageAPIView.as_view(), name="seller_product_image"),
